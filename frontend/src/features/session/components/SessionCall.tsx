    ...
    <main className="relative h-full w-full overflow-hidden bg-[#fbf8ff] text-[#221447]">
      ...
      <div className="relative z-10 flex h-full min-h-0 w-full flex-col px-[var(--stage-inline-pad)] pb-[var(--stage-safe-bottom)] pt-[var(--stage-safe-top)]">
        ...
        <button
          ...
          className={`absolute left-4 top-4 z-20 inline-flex items-center gap-2 rounded-full border px-3 py-2 text-xs font-bold uppercase tracking-[0.2em] shadow-sm backdrop-blur-md transition ${
            captionsEnabled
        ...
        {captionsEnabled && captionsOverlayOpen ? (
          <div className="absolute inset-x-0 bottom-0 z-30 mx-auto w-full max-w-[720px] px-3 pb-3">
            <div className="rounded-3xl border border-white/40 bg-[#120f22]/95 text-white shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-md">
              ...
              >
                {playbackSubtitle ? (
                  <div className="mb-4 rounded-3xl border border-white/15 bg-[#5b3fd6]/20 px-4 py-4 text-lg font-semibold leading-8 text-white">
                    {playbackSubtitle}
                  </div>
                ) : null}
