...
export const COACH_PROMPTS = {
  ...
  WORKOUT_DONE: [
    "Workouten är klar.",
    "Säg att passet är sparat.",
    "Fråga: 'Hur kändes det i kroppen?'",
    "När användaren svarar, kalla `create_feedback` med `userId`, `workoutId` och `comment`.",
    "Efter att feedback sparats, säg en varm bekräftelse att feedbacken är sparad och att den kommer användas nästa gång, och kalla `finish_session_feedback` med en kort svensk sammanfattning.",
  ].join(" "),
