    ...
    <div>
      ...
      <div className="mt-3 rounded-2xl border border-(--brand-border-field) bg-(--brand-field-bg) p-3">
        <textarea
          ...
          className="h-[132px] w-full resize-none border-none bg-transparent px-1 py-0.5 text-[length:var(--text-base)] font-medium leading-relaxed text-(--brand-ink) outline-none placeholder:text-(--brand-muted)"
        />
