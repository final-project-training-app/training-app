    ...
    <section className="space-y-5">
      ...
      <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-[#ece5ff] bg-white px-4 py-3 shadow-sm">
        <div className="relative min-w-40 flex-1">
          <svg
            className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-[#b0a8d0]"
            width="13"
            height="13"
            viewBox="0 0 24 24"
            fill="none"
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-[10px] font-bold uppercase tracking-wider text-[#b0a8d0]">
